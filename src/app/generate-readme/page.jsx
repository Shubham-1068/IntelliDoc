...
const ReadmeGenerator = () => {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      console.log(`Fetching GitHub repo data for ${owner}/${repo}`);
      ...
      // Send repoData to server-side POST endpoint
      ...
      if (!contentType || !contentType.includes('application/json')) {
        ...
        throw new Error('Server returned a non-JSON response. Check the API endpoint.');
      }
      ...
      alert(error.message || 'Failed to generate README. Please try again.');
    } finally {
      setLoading(false);
    }
  };
      ...
      >
        <motion.div className="text-center mb-12" variants={itemVariants}>
          <div className="inline-flex items-center gap-2 mb-4">
            ...
            <h1 className="text-5xl font-bold bg-gradient-to-r from-[#008df3] to-blue-400 bg-clip-text text-transparent">
              README Generator
            </h1>
          </div>
          ...
          <div className="flex justify-center gap-2 mt-4">
            <span className="inline-flex items-center px-3 py-1 rounded-full text-sm bg-[#008df3]/20 text-[#008df3] border border-[#008df3]/30">
              <svg className="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 24 24">
                <path d="M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09zM18.259 8.715L18 9.75l-.259-1.035a3.375 3.375 0 00-2.456-2.456L14.25 6l1.036-.259a3.375 3.375 0 002.456-2.456L18 2.25l.259 1.035a3.375 3.375 0 002.456 2.456L21.75 6l-1.035.259a3.375 3.375 0 00-2.456 2.456zM16.894 20.25L16.5 21.75l-.394-1.5a2.25 2.25 0 00-1.637-1.637L13.5 18l.966-.244a2.25 2.25 0 001.637-1.637L16.5 14.25l.394 1.5a2.25 2.25 0 001.637 1.637l.966.244-.966.244z" />
              </svg>
              AI Powered
            </span>
